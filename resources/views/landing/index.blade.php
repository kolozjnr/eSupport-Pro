<x-guest-layout>
                ...
                <div class="w-full px-4 lg:w-1/2">
                  ...
                  >
                    <div class="absolute left-0 top-0">
                      <img src="{{ asset('landing/images/about/image-6.jpeg')}}" alt="about-image" />
                    </div>
                    <div
                      class="absolute right-0 top-1/2 z-10 -translate-y-1/2"
                    >
                      <img src="{{ asset('landing/images/about/image-4.jpeg')}}" alt="about-image" />
                      <div
            ...
            <div class="tabPanel">
              ...
              >
                <div class="w-full px-4 lg:w-1/2">
                  ...
                  >
                    <div class="absolute left-0 top-0">
                      <img src="{{asset('landing/images/about/image-6.jpg')}}" alt="about-image" />
                    </div>
                    <div
                      class="absolute right-0 top-1/2 z-10 -translate-y-1/2"
                    >
                      <img src="{{asset('landing/images/about/image-4.jpg')}}" alt="about-image" />
                      <div
                        class="absolute -left-5 -top-5 -z-10 h-full w-full border border-primary border-opacity-10 bg-primary bg-opacity-5 backdrop-blur-[6px] dark:border-white dark:border-opacity-10 dark:bg-white dark:bg-opacity-10"
                      ></div>
                    </div>
    ...
    <section id="pricing" class="pt-14 sm:pt-20 lg:pt-[130px]">
      <div class="px-4 xl:container">
        ...
        <div
          class="relative z-10 flex flex-wrap justify-center overflow-hidden mb-10 rounded drop-shadow-light dark:drop-shadow-none"
        >
          <div
            class="absolute top-0 left-0 -z-10 h-full w-full bg-cover bg-center opacity-10 dark:opacity-40 bg-noise-pattern"
          ></div>
          ...
          <div class="w-full sm:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="border-b py-10 dark:border-[#2E333D]">
                ...
                <sup class="-mb-2 text-[45px]"> {{$settings->citizen_desk_plan_amount}} </sup>
                  /month
                </h3>
            ...
            >
              ...
              <div class="border-b py-10 dark:border-[#2E333D]">
                ...
                >
                   ...
                   <sup class="-mb-2 text-[45px]"> {{$settings->startup_up_amount}} </sup>
                  /month
                </h3>
          ...
          <div class="w-full sm:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="border-b py-10 dark:border-[#2E333D]">
                ...
                <span class="font-bold text-2xl -me-2 mr-4">&#8358;</span>
                <sup class="-mb-2 text-[45px]"> {{$settings->team_amount}} </sup>
                  /month
                </h3>
        ...
        {{-- second row pricing --}}
         <div
          class="relative z-10 flex flex-wrap justify-center overflow-hidden rounded drop-shadow-light dark:drop-shadow-none mt-8"
        >
          <div
            class="absolute top-0 left-0 -z-10 h-full w-full bg-cover bg-center opacity-10 dark:opacity-40 bg-noise-pattern"
          ></div>
          ...
          <div class="w-full sm:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="border-b py-10 dark:border-[#2E333D]">
                ...
                <span class="font-bold text-2xl -me-2 mr-4">&#8358;</span> 
                <sup class="-mb-2 text-[45px]"> {{$settings->enterprise_amount}} </sup>
                  /month
                </h3>
