            ...
            <main class="flex-grow p-6"> 
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        ...
                        <div class="flex items-center gap-2">
                            <i class="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                            <a href="#" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Customers</a>
                        </div>
                    </div>
                </div>
                <!-- Page Title End -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                <h4 class="card-title">Verified Customers</h4>
                            </div>
                        </div>
                        <div class="p-6">
...
<script>
     ...
     async function verifiedCustomers() {
    const tableContainer = document.getElementById("verified-customers");
    ...
    try {
        ...
        const response = await fetch('/dashboard/administrator/get-verified-customers', {
            headers: {
        ...
        const subscriptions = data.customers;
            ...
            new gridjs.Grid({
                columns: [
                    ...
                    // },
                       {
                        ...
                        formatter: (cell) => {
                            const name = cell || 'N/A';
                            return gridjs.html(`<span class="fw-semibold">${name}</span>`);
                    ...
                    },
                    {
                        name: 'Business Name',
                        formatter: (cell) => {
                            const biz_name = cell || 'N/A';
                            return gridjs.html(`<span class="fw-semibold">${biz_name}</span>`);
                        ...
                        formatter: (cell) => {
                            ...
                            const nin = cell || 'N/A';
                            return gridjs.html(`<span class="fw-semibold">${nin}</span>`);
                        },
                        width: '25%',
                    },
                    {
                        ...
                        formatter: (cell) => {
                            ...
                            if (!cell) return 'N/A';
                            const tel = cell || 'N/A';
                            return gridjs.html(`<span class="fw-semibold">${tel}</span>`);
                        },
                    },
                    {
                        name: 'Created At',
                ...
                sort: true,
                search: true,
                    data: subscriptions.map((cust, index) => [
                    cust.id,                                          // ID
                    index + 1,                    // Auto-increment number starting from 1
                    cust.user.fname + cust.user.lname || 'N/A',                                        // Auto-increment number starting from 1
                    cust.business_name || 'N/A',                // REF (will be extracted from customer in formatter)
                    cust.nin || 'N/A',                    // REF (will be extracted from customer in formatter)
                    cust.phone_number || 'N/A',                              // REF (will be extracted from customer in formatter)
                    cust.address || 'N/A',                                          // Amount
                    cust.created_at || 'N/A',                             // Status
