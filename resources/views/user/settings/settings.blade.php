                        ...
                        <div class="card">
                            ...
                            <div x-data="settings()" class="p-6">
                                    ...
                                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data"
                                        ...
                                        <div class="grid grid-cols-4 gap-4 mb-6">
                                            ...
                                            <div>
                                             ...
                                             <div>
                                                <label for="billing_email" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Support Email</label>
                                        ...
                                        <div class="grid grid-cols-4 gap-4 mb-6">
                                            ...
                                            <div>
                                             ...
                                             <div>
                                                <label for="fav_icon" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Support Email</label>
                                                <input type="email" class="form-input" x-model="formData.billing_email" name="billing_email" id="billing_email" placeholder="support@eltech.com">
                                            </div>
                                        </div>
                                ...
                                <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="grid grid-cols-4 gap-4 mb-6">
                                        <div>
                                            <label for="fname" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">General support charge</label>
                                            <input type="number" class="form-input" x-model="formData.general_support" name="general_support" id="general_support" value="">
                                        </div>
                                        <div>
                                            <label for="mname" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Call Center Charge</label>
                                        ...
                                        <div>
                                            <label for="lname" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Virtual Support Charge</label>
